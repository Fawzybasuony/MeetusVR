...
export default function Login() {
  ...
  const onSubmit = async (data) => {
    if (data.email !== "dev.aert@gmail.com" || data.password !== "helloworld") {
  ...
  return (
    <div className="text-center flex justify-between items-center bg-[#E9ECF2]  h-screen relative overflow-hidden">
      ...
      <div className="w-1/2 h-screen flex items-center  ">
        <div className="mx-auto  ">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            {/* Email Input */}
            <div className="flex items-center border-2 border-white bg-[#FFFFFF66] rounded-lg mt-5 p-3 mb-2 w-full">
              <svg
                width="20"
                height="20"
                viewBox="0 0 24 24"
            ...
            {errors.email && (
              <p className="text-start text-red-500 text-sm mb-3">
                {errors.email.message}
              </p>
            )}

            {/* Password Input */}
            <div className="flex items-center border-2 border-white bg-[#FFFFFF66]  rounded-lg p-3 mb-2 w-full">
              <svg
                width="20"
                height="20"
                viewBox="0 0 24 24"
            ...
            {errors.password && (
              <p className="text-start text-red-500 text-sm mb-5">
            ...
            <button
              type="submit"
              disabled={!isValid}
              className={`cursor-pointer w-full py-3 px-5 rounded-lg text-white font-semibold transition ${
                isValid
                  ? "bg-[#9414FF] hover:bg-[#9b2ff4]"
      ...
      {/* Right Section */}
      <div className="heddin w-1/2 h-screen flex items-center">
        <div className=" absolute top-[-100px] w-[500px] h-[300px] bg-[#E477F6] blur-[150px]" />

        <img
          className="p-20 z-50"
          src={"/Frame 1216257798.png"}
          alt="MeetusVR"
        />
        <div className="absolute  bottom-[-250px] left-[1100px] w-[500px] h-[400px] bg-[#9E77F6] blur-[100px]" />
      </div>
    </div>
  );
}
